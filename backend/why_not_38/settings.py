"""
Django settings for why_not_38 project.
...
WSGI_APPLICATION = 'why_not_38.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "why_not_38 API",
    "DESCRIPTION": "API documentation for why_not_38 App",
    "VERSION": "v1",
}
